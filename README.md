...
You can skip following step if you init project with expo
```
expo init s3-react-native-tutorial

```

```
s3-react-native-tutorial  ▸ ⁨ios⁩
s3-react-native-tutorial.xcodeproj
```

```
s3-react-native-tutorial⁩ ▸ ⁨node_modules⁩ ▸ ⁨react-native⁩ ▸ ⁨Libraries⁩ ▸ ⁨CameraRoll⁩
